...
output += "\r\n\t\t\t\t</a>\r\n\t\t\t</li>\r\n\t\t\t<li class=\"nav-item dropdown\">\r\n\t\t\t\t<a class=\"nav-link dropdown-toggle\" href=\"#\" data-toggle=\"dropdown\" role=\"button\" aria-haspopup=\"true\" aria-expanded=\"false\">Other<span class=\"caret\"></span></a>\r\n\t\t\t\t<ul class=\"dropdown-menu\">\r\n\t\t\t\t\t<li><a class=\"nav-link\" href=\"#\" data-on=\"click:importFromJSON\">";
output += runtime.suppressValue(env.getFilter("i18n").call(context, "toolbar.importJSON"), env.opts.autoescape);
output += "</a></li>\r\n\t\t\t\t\t<li role=\"separator\" class=\"divider\"></li>\r\n\t\t\t\t\t<li><a class=\"nav-link\" href=\"#\" data-on=\"click:exportToJSON\">";
output += runtime.suppressValue(env.getFilter("i18n").call(context, "toolbar.exportJSON"), env.opts.autoescape);
output += "</a></li>\r\n\t\t\t\t</ul>\r\n\t\t\t</li>\r\n\t\t\t";
