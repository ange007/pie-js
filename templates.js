...
for(var t_21 in t_10) {
t_8++;
var t_22 = t_10[t_21];
frame.set("tabID", t_21);
frame.set("tab", t_22);
frame.set("loop.index", t_8 + 1);
frame.set("loop.index0", t_8);
frame.set("loop.revindex", t_9 - t_8);
...
output += "\">\r\n\t\t\t";
if(env.getFilter("length").call(context, runtime.memberLookup((t_22),"title")) > 0) {
output += "\t\r\n\t\t\t\t<legend class=\"tab-title\">";
...
output += "\r\n\r\n\t\t\t";
if(env.getFilter("length").call(context, runtime.memberLookup((t_22),"items")) > 0) {
output += "\r\n\t\t\t\t<ul class=\"nav nav-pills nav-stacked\">\r\n\t\t\t\t\t";
frame = frame.push();
var t_25 = runtime.memberLookup((t_22),"items");
...
output += "\r\n\t\t\t\t\t\t<li>\r\n\t\t\t\t\t\t\t";
env.getTemplate("tabs/" + t_21 + "-item.tpl", false, "sidebar.tpl", null, function(t_29,t_27) {
...
output += "\r\n\t\t</select>\r\n\t</div>\r\n</div>\r\n<div>\r\n    <div id=\"stickers\">\r\n\t\t";
frame = frame.push();
var t_10 = runtime.contextOrFrameLookup(context, frame, "stickers");
...
frame.set("loop.length", t_9);
output += "\r\n\t\t\t";
env.getTemplate("tabs/stickers-item.tpl", false, "tabs/stickers.tpl", null, function(t_14,t_12) {
...
frame = frame.push();
var t_10 = runtime.contextOrFrameLookup(context, frame, "fonts");
if(t_10) {var t_9 = t_10.length;
for(var t_8=0; t_8 < t_10.length; t_8++) {
var t_11 = t_10[t_8];
frame.set("item", t_11);
...
frame.set("loop.length", t_9);
output += "\r\n\t\t\t<li>\r\n\t\t\t\t";
env.getTemplate("tabs/text-item.tpl", false, "tabs/text.tpl", null, function(t_14,t_12) {
if(t_14) { cb(t_14); return; }
t_12.render(context.getVariables(), frame, function(t_15,t_13) {
if(t_15) { cb(t_15); return; }
output += t_13
